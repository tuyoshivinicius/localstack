...
from localstack.utils.common import poll_condition, retry, short_uid, to_bytes, to_str
...
def test_firehose_http(lambda_processor_enabled: bool, httpserver, make_httpserver):
    ...
    assert destination_description["EndpointConfiguration"]["Url"] == endpoint
    ...
    def _assert_record():
        request = httpserver.log[0][0].get_json(force=True)
        received_record = request["records"][0]
